...
class SunanHadithDetailsUrdu extends StatefulWidget {
  ...
  const SunanHadithDetailsUrdu({super.key, this.chapterno});

  @override
  State<SunanHadithDetailsUrdu> createState() => _SunanHadithDetailsUrduState();
}

class _SunanHadithDetailsUrduState extends State<SunanHadithDetailsUrdu> {
  List<Data> haditsss = [];
  bool isLoading = true;
  bool hasError = false;
