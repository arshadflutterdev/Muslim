...
class MajahDetailedUrdu extends StatefulWidget {
  final String? chapterIdss;
  const MajahDetailedUrdu({super.key, this.chapterIdss});

  @override
  State<MajahDetailedUrdu> createState() => _MajahDetailedUrduState();
}

class _MajahDetailedUrduState extends State<MajahDetailedUrdu> {
  List<Data> haditsss = [];
  bool isLoading = true;
  bool hasError = false;
